			...
			if (a(this).data("text") != undefined) {
				...
				if (a(this).data("type") != undefined) {
					...
					if (i == "half") {
						...
						a(this).find(".circle-text-half").css({"line-height": (H / 1.45) + "px", "font-size": s + "px"})
					} else {
						a(this).append('<span class="circle-text">' + r + E + "</span>");
						a(this).find(".circle-text").css({"line-height": H + "px", "font-size": s + "px"})
					}
				} else {
					a(this).append('<span class="circle-text">' + r + E + "</span>");
					a(this).find(".circle-text").css({"line-height": H + "px", "font-size": s + "px"})
			...
			if (a(this).data("info") != undefined) {
				...
				if (a(this).data("type") != undefined) {
					...
					if (i == "half") {
						...
						a(this).find(".circle-info-half").css({"line-height": (H * 0.9) + "px"})
					} else {
						a(this).append('<span class="circle-info">' + F + "</span>");
						a(this).find(".circle-info").css({"line-height": (H * 1.25) + "px"})
					}
				} else {
					a(this).append('<span class="circle-info">' + F + "</span>");
					a(this).find(".circle-info").css({"line-height": (H * 1.25) + "px"})
